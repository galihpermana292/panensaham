    ...
    <>
      <div className="navv sticky-top">
        <div className="nav-css ">
          <div className="nav-menuu" onClick={handleClick}>
            <AiOutlineMenu />
          </div>
          <div className="logo" onClick={handleMarket}>
            <a href="#">
              <img src={PanenSahamLogo} />
            </a>
          </div>
          <div className={!menuOpen ? "nav-links" : "nav-linkss"}>
            ...
            <ul className="links">
              ...
              <li>
                ...
                <span className="arrow toolAdvanced">
                  <BiCaretDown />
                </span>
                <ul className="tool-submenu submenu">
                  <li>
                    <a href="#">Chat Advanced</a>
                  </li>
                  <li>
                    <a href="#">Fitur Advanced</a>
                  </li>
                </ul>
              </li>
              <li>
