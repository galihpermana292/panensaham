  ...
  useEffect(
    () => {
      ...
      function createWidget() {
        if (document.getElementById('tradingview_fc40e') && 'TradingView' in window) {
    ...
    return(
            ...
            <div className="up-container d-lg-flex">
                ...
                <div className="border  rt-container-left">
                    ...
                    <div className="d-flex justify-content-between">
                        <div className="rt-head p-2">
                            Running Trade
                        </div>
                        <div className="">
                            <button className="btn-trading"
                        ...
                        <Setruningtrade show={showSetRuningTrade} setShow={setShowSetRuningTrade}  />
                    </div>
                        ...
                        <table  className="rt-subtitle scroll">
                            <tbody >
                                <tr className="sticky">
                                    ...
                                    <th colspan='2' className="pl-4 pr-5">Change</th>
      ...
      <div className="tradingview-widget-copyright">
        <a href="https://www.tradingview.com/symbols/NASDAQ-AAPL/" rel="noopener" target="_blank"><span className="blue-text">AAPL stock chart</span></a> by TradingView
                    ...
                    <div className="mt-2 p-3  " >
                     ...
                     <div className="d-lg-flex justify-content-between pl-2">
                        <div className="d-flex mr-3">
                            <div className="subtitle-order width-above">
                                Trailing Stop
                            </div>
                            <div >
                        ...
                        <div className="d-flex mr-1">
                            ...
                            <div className="subtitle-order text-success">
                                Buy
                            </div>
                        </div>
                        <div className="d-flex mr-2">
                            ...
                            <div className="subtitle-order text-danger">
                                Sell
                            </div>
                        </div>
                        
                    </div> 
                    <div className="text-right text-danger disclaimer pr-2"><span className="border p-1 rounded border-danger">Disclaimer Berdasarkan On Monica</span></div>
                    <div>
                        <div className="pl-3 d-flex justify-content-between pr-2 mt-3">
                            <div>
                                <input type="checkbox"  value="Prevent" /><span className="subtitle-order pl-1">Prevent Repeat Order</span>
                            </div>
                            <div >
                                <button className="btn-cashlimit text-cashlimit mr-3 " >Cash</button>
                                <button className="btn-cashlimit text-cashlimit ">Limit</button>
                            </div>
                        </div>
                    </div>
                    <div>
                            ...
                            <div className="subtitle-order">
                                <div className="d-flex mb-1">
                                    ...
                                    <div>
                                        ...
                                        onClick={() => setShowHargaBidOffer(true)}><FiSearch/></button>
                                    </div>
                                    <HargaBidOffer show={showHargaBidOffer} setShow={setShowHargaBidOffer}  />
                                </div>
                                <div>
                                    <div className="d-flex mb-1">
                                        <div className="width-subtitle">
                    ...
                    <div className="d-lg-flex m-3 justify-content-around">
                        <button className="btn-buy mr-3 text-white " style={{background: '#EAA621'}}>AMMEND</button>
                ...
                <div className="border  rt-container-left ">
                    ...
                    <div className="border">
                        ...
                        <div className="d-flex">
                            ...
                            <div className="border p-2 sp-sub-title pl-5 pr-5">PT. Bank Rakyat Indonesia</div>
                        ...
                        <div className="d-flex justify-content-between ml-3 mr-3 text-center sp-detail">
                            <div className="p-2">
                                <div >Prev <span className="text-success pl-3">4350</span></div>
                                <div>Chg <span className="text-success pl-3">+100</span></div>
                                <div className="text-right">% <span className="text-success pl-4">3,98%</span></div>
                                <div>Freq <span className="text-success pl-3">1,302</span></div>
                            </div>
                            <div>
                                <div >Open <span className="text-success pl-3">4.500</span></div>
                                <div>High <span className="text-success pl-3">4.700</span></div>
                                <div className="text-right">Low <span className="text-danger pl-3">4.450</span></div>
                                <div>IEP <span className="pl-3">68,88</span></div>
                            </div>
                            <div>
                                <div >Lot<span className="text-success pl-3">1,298 K</span></div>
                                <div>Val <span className="text-success pl-3">212,3 B</span></div>
                                <div >Avg <span className="text-success pl-3">4.500</span></div>
                                <div>IEV <span className="pl-3">68,88</span></div>
                            </div>
                        </div>
                    ...
                    <div className="" >
                        ...
                        <div className="bg-warning d-flex m-auto justify-content-start stock-title ">
                            ...
                            <div className={toggleStock === 'stockdone' ? 'p-2 stock-title-active' : 'p-2  ' }
                            onClick={() => toggleStockTab("stockdone")}>
                                STOCK DONE
                            </div>
                            <div className={toggleStock === 'stockinfo' ? 'p-2 stock-title-active' : 'p-2   '}
                            onClick={() => toggleStockTab("stockinfo")}>
                                STOCK INFO
                            </div>
                        </div>
                        {/* Stock Done */}
                        <div className={toggleStock === "stockdone" ? 'table-wrapper-sd stock-active-content' : 'table-wrapper-sd stock-content'}>
                            <table  className="rt-subtitle scroll ">
                                <tbody>
                                    <tr className="sticky ">
                                        <th className=" pl-3 pr-3">Time</th>
                                        <th className=" pl-3 pr-3">Last</th>
                                        <th colspan='2' className=" pl-3 pr-3">Change(%)</th>
                                    ...
                                    {stockDown.map((item, index) => (
                                        ...
                                        <td className="text-success"><IoMdArrowDropup/>{item.changeFirst}</td>
                                        <td className="text-success"><IoMdArrowDropup/>{item.changeLast} %</td>
                        ...
                        {/* Stock Info */}
                        <div className={toggleStock === "stockinfo" ? 'table-wrapper-sd stock-active-content' : 'table-wrapper-sd stock-content'}>
                            <table  className="rt-subtitle scroll ">
                                <tbody>
                                    <tr className="sticky ">
                                        <th className=" pl-3 pr-3">Price</th>
                                    ...
                                    {stockInfo.map((item, index) => (
                                        ...
                                        <td className={item.Bfreq > item.Sfreq ? 'text-success' : 'text-danger'}>{item.Bfreq}</td>
                                        <td className={item.Sfreq > item.Bfreq ? 'text-success' : 'text-danger'}>{item.Sfreq}</td>
                                    </tr>
                                    ))}
                                </tbody>  
                            </table>      
            ...
            <div className="down-container  d-lg-flex justify-content-arround mt-3 mb-5">
                <div className="border marketContainer mr-3 ">
                    <div className="bg-warning title-market p-2">
                        Market News
                    </div>
                ...
                <div className="border wopContainer">
                    ...
                    <div className="bg-warning title-wop p-2 d-flex p-2">
                        <div className={toggleWop==="watchlist" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"} 
                        onClick={() => toggleWopTab("watchlist")}>
                            WATCHLIST
                        </div>
                        <div className={toggleWop==="orderlist" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                        onClick={() => toggleWopTab("orderlist")}> 
                            ORDER LIST
                        </div>
                        <div className={toggleWop==="portfolio" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                    ...
                    {/* WatchList */}
                    <div className={toggleWop==="watchlist" ? 'wop-active-content' : 'wop-content' }>
                        <div className="p-2">
                            <input type='text' className="input-watchlist" placeholder="BBRI"></input>
                    ...
                    {/* Order List  */}
                     <div className={toggleWop==="orderlist" ? 'wop-active-content' : 'wop-content' }>
                        {/* Title part of order list */}
                        <div className="p-2 order-title d-flex m-1 ">
                            <div className={toggleOrder==="openOrders" ? "ml-2 mr-2 font-weight-bold text-dark wop " : "wop ml-2 mr-2"} 
                            onClick={() => toggleOrderTab("openOrders")}>
                                Open Orders
                            </div>
                            <div className={toggleOrder==="closedHistory" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                            onClick={() => toggleOrderTab("closedHistory")}> 
                                Closed History
                            </div>
                            <div className={toggleOrder==="orderHistory" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                            onClick={() => toggleOrderTab("orderHistory")}>
                                Order History
                            </div>
                            <div className={toggleOrder==="tradeList" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                        ...
                        <div className="watchlist-wrap">
                             {/* // Open Orders */}
                             <table width={'890px'}  className={toggleOrder==='openOrders' ? "border " : "border order-content"}>
                                <thead>
                                    <tr className="text-detail-watchlist text-center">
                            ...
                            {/* // Closed History */}
                            <table width={'890px'}  className={toggleOrder==='closedHistory' ? "border " : "border order-content"}>
                            ...
                            {/* // Order History */}
                            <table width={'890px'}  className={toggleOrder==='orderHistory' ? "border " : "border order-content"}>
                              ...
                              {/* //  Trade List  */}
                            <table width={'890px'}  
                            className={toggleOrder==='tradeList' ? "border" : "border order-content"}>
                                <thead>
                                    <tr className="text-detail-watchlist text-center">
                                        <td className="p-1">Code</td>
                                        <td>Time</td>
                    ...
                    {/* Portfolio */}
                    <div className={toggleWop==="portfolio" ? 'wop-active-content' : 'wop-content' }>
                        {/* Title part of order list */}
                        <div className="p-2 order-title d-flex m-1 ">
                                <div className={togglePortfolio==="stockPortfolio" ? "ml-2 mr-2 font-weight-bold text-dark wop " : "wop ml-2 mr-2"} 
                                onClick={() => togglePortfolioTab("stockPortfolio")}>
                                    Stock
                                </div>
                                <div className={togglePortfolio==="cashPortfolio" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                                onClick={() => togglePortfolioTab("cashPortfolio")}> 
                                    Cash
                                </div>
                                <div className={togglePortfolio==="mutualPortfolio" ? "ml-2 mr-2 font-weight-bold text-dark wop" : "wop ml-2 mr-2"}
                        ...
                        <div className="watchlist-wrap">
                             {/* // Stock Portfolio */}
                             <table width={'890px'}  className={togglePortfolio==='stockPortfolio' ? "border " : "border portfolio-content"}>
                                <thead>
                                    <tr className="text-detail-watchlist text-center">
                                        <td className="p-1">Code</td>
                                        <td>Average</td>
                            ...
                            {/* // cash Portfolio */}
                            <table width={'890px'} height={'200px'} className={togglePortfolio==='cashPortfolio' ? "border " : "border portfolio-content"}>
                                <thead>
                                    <tr className="text-detail-watchlist text-center">
                                        <td ></td>
                             ...
                             <table width={'890px'}  className={togglePortfolio==='mutualPortfolio' ? "border " : "border portfolio-content"}>
                                <thead>
                                    <tr className="text-detail-watchlist text-center">
